...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground selection:bg-primary/30 selection:text-foreground p-6 relative overflow-hidden">
      {/* Decorative Orbs */}
